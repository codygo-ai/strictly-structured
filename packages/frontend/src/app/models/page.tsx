...
if (typeof ruleSetsData.meta?.sourcesDisplay !== 'string') {
  throw new Error('schema_rule_sets.json: meta.sourcesDisplay is required.');
}
if (
  !ruleSetsData.meta?.providerBadgeClasses ||
  typeof ruleSetsData.meta.providerBadgeClasses !== 'object'
) {
  throw new Error('schema_rule_sets.json: meta.providerBadgeClasses is required.');
}
if (
  !ruleSetsData.meta?.comparisonLegend ||
  typeof ruleSetsData.meta.comparisonLegend !== 'object'
) {
  throw new Error('schema_rule_sets.json: meta.comparisonLegend is required.');
}
if (
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-lg border border-border bg-surface p-6">
        <h2 className="text-[15px] font-bold text-primary mb-4">Quick Comparison</h2>
        <ComparisonTable
