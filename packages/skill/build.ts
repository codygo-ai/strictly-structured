...
// Copy plugin.json
cpSync(join(__dirname, 'plugin.json'), join(pluginRoot, '.claude-plugin', 'plugin.json'));

// Copy SKILL.md
cpSync(join(skillDir, 'SKILL.md'), join(pluginSkillDir, 'SKILL.md'));
...
// Copy reference docs
cpSync(join(skillDir, 'reference'), join(pluginSkillDir, 'reference'), { recursive: true });

// Copy examples
cpSync(join(skillDir, 'examples'), join(pluginSkillDir, 'examples'), { recursive: true });
